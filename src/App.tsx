...
import { LayoutDashboard, PlusCircle, Users, Briefcase, ChevronRight } from "lucide-react";
    ...
    <aside className="w-72 bg-white border-r border-slate-200 flex flex-col h-screen sticky top-0">
      <div className="p-8">
        ...
        <nav className="space-y-2">
          ...
          <div className="pt-4">
            <p className="text-[11px] font-bold text-slate-400 uppercase tracking-widest px-4 mb-4">Recruitment</p>
